...
with(data_small,plot(datetime,Global_active_power,type='l',xlab=NA,ylab="Global Active Power"))
...
with(data_small,plot(datetime,Voltage,type='l',ylab="Voltage"))

with(data_small,plot(datetime,Global_reactive_power,type='l'))
dev.off()